...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,3200/1.25,((700*.1388888)*5.18)*.8620689}                    // default steps per unit for ultimaker 
#define DEFAULT_MAX_FEEDRATE          {200000, 200000, 240, 500000}    // (mm/sec)    
